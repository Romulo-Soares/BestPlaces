...
<html>
    <head>
        ...
        <title>Pesquisar Local Evento</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div id="divContPes">
                ...
                <div id="divPesLocal">
                <form action="pesquisarLocalEvento.jsp" method="post" name="pesquisarLocal">   
                ...
                <c:if test="${not empty locais and not empty param.nome}">
                    <c:forEach var="locais" items="${locais}">
                        <form action="cadastroEvento.jsp" method="post" name="perfilLocal">
                            <div class="form-group">
                                <div id="divResultado">
                                    ...
                                    <div id="divPesbt" class="form-group">
                                        ...
                                        <input type="submit" class="btn btn-danger btn-md btn-block" id="btPes" role="button" value="Adicionar Local"> 
                                    </div>
                                </div>  
                            </div>
                        </form>
